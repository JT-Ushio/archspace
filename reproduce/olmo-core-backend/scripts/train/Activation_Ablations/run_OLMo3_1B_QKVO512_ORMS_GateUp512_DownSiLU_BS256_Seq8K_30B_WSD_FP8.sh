...
RUN_NAME="${RUN_NAME:-olmo3-1b-qkvo512-o-rms-gateup512-down-silu-bs256-seq8k-30b-wsd-fp8-5e-3}"
STAGE="${STAGE:-stage1}"
...
exec "${OLMO_ENV}/bin/python" -m torch.distributed.run \
  ...
  cfps/BS256_Seq8K_30B_WSD_FP8/Activation_Ablations/OLMo3-1B-QKVO512-ORMS-GateUp512-DownSiLU.py \
  --name "${RUN_NAME}" \
