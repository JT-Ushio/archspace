...
# Environment Variables: set in /mnt/shared-storage-user/jitao/envs/MoSE/etc/conda/activate.d/prepare.sh

# cd /mnt/shared-storage-user/jitao/code/archspace-MoSE/reproduce/olmo-core-backend
cd /mnt/shared-storage-user/shijiayang-p/archspace-MoSE/reproduce/olmo-core-backend
RUN_NAME=olmo3-1b-SiTU-up-5e-3
STAGE=stage1
